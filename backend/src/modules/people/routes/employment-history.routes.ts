...
} from "../schemas/employment-history.schemas.js";
...
export async function registerEmploymentHistoryRoutes(app: FastifyInstance) {
  ...
  app.post(
    "/persons/:personId/employment-history",
    {
      schema: {
        ...
        preValidation: async (request: any, reply: any) => {
          try {
            employmentHistoryCreateSchema.parse({
              ...request.body,
              pehPerId: Number(request.params.personId),
            });
          } catch (error: any) {
    ...
    async (request: any, reply) => {
      try {
        ...
        const validatedBody = employmentHistoryCreateSchema.parse({
          ...request.body,
          pehPerId: Number(request.params.personId),
        });
  ...
  app.get(
    ...
    async (request: any, reply) => {
      const history = await historyService.getByPersonId(
  ...
  app.put(
    ...
    async (request: any, reply) => {
      try {
        ...
        const history = await historyService.update(
