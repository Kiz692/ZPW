...
import {
  personIdentifierCreateSchema,
  personIdentifierUpdateSchema,
} from "../schemas/person-identifier.schemas.js";
...
export async function registerPersonIdentifierRoutes(app: FastifyInstance) {
  ...
  app.post(
    "/persons/:personId/identifiers",
    {
      schema: {
        ...
        preValidation: async (request: any, reply: any) => {
          try {
            personIdentifierCreateSchema.parse({
              ...request.body,
              idnPerId: Number(request.params.personId),
            });
          } catch (error: any) {
    ...
    async (request: any, reply) => {
      try {
        ...
        const validatedBody = personIdentifierCreateSchema.parse({
          ...request.body,
          idnPerId: Number(request.params.personId),
        });
  ...
  app.get(
    ...
    async (request: any, reply) => {
      const identifiers = await identifierService.getByPersonId(
  ...
  app.get(
    ...
    async (request: any, reply) => {
      try {
        const identifier = await identifierService.getById(
  ...
  app.put(
    ...
    async (request: any, reply) => {
      try {
        ...
        const identifier = await identifierService.update(
          Number(request.params.id),
          validatedBody,
          userId,
        );
