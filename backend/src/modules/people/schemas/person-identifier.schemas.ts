...
const identifierTypeCodes = z.enum([
  "NATIONAL_ID",
  "PASSPORT",
  "TAX_PIN",
  "DRIVERS_LICENSE",
...
export const personIdentifierCreateSchema = z
  .object({
  ...
  .refine(
    (data) =>
      !data.idnValidFrom ||
      !data.idnValidTo ||
      data.idnValidFrom <= data.idnValidTo,
    {
...
export type PersonIdentifierCreateInput = z.infer<
  typeof personIdentifierCreateSchema
>;
export type PersonIdentifierUpdateInput = z.infer<
  typeof personIdentifierUpdateSchema
>;
