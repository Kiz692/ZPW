...
export const personContactCreateSchema = z
  ...
  .refine(
    (data) => {
      ...
      if (
        data.pcoContactTypeCode === "MOBILE" ||
        data.pcoContactTypeCode === "PHONE"
      ) {
...
export type PersonContactCreateInput = z.infer<
  typeof personContactCreateSchema
>;
export type PersonContactUpdateInput = z.infer<
  typeof personContactUpdateSchema
>;
