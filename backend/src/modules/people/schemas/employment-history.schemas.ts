...
export const employmentHistoryCreateSchema = z
  ...
  .refine(
    (data) =>
      !data.pehStartDate ||
      !data.pehEndDate ||
      data.pehStartDate <= data.pehEndDate,
    {
...
export type EmploymentHistoryCreateInput = z.infer<
  typeof employmentHistoryCreateSchema
>;
export type EmploymentHistoryUpdateInput = z.infer<
  typeof employmentHistoryUpdateSchema
>;
